...
if (isset($_POST['syear'])) {
    ...
    <form method=POST>
        ...
        <p align=left>Title:<input class=input-xxlarge type=text name=title size=71
                                   value="<?php echo isset($title) ? $title : "" ?>"></p>
        ...
        <p align=left>End Time:<br>&nbsp;&nbsp;&nbsp;
            ...
            Day:<input class=input-mini type=text name=eday size=2
                       value=<?php echo date('d') + (date('H') + 4 > 23 ? 1 : 0) ?>>&nbsp;
        ...
        <br>Problems:<input class=input-xxlarge placeholder="Example:1000,1001,1002" type=text size=60 name=cproblem
