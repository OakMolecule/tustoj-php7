...
<center>
    ...
    ?>
    <p align="center"><font color="#333399" size="4">Welcome To Administrator's Page of Judge Online of ACM
            ICPC, <?php echo $OJ_NAME ?>.</font>
    <td width="100"></td>
</center>
<hr>
...
<form method=POST action=problem_edit.php>
    ...
    <p>Title:<input type=text name=title size=71 value='<?php echo htmlentities($row->title, ENT_QUOTES, "UTF-8") ?>'>
    </p>
    ...
    <p>Description:<br><textarea class="kindeditor" rows=13 name=description
                                 cols=120><?php echo htmlentities($row->description, ENT_QUOTES, "UTF-8") ?></textarea>
    </p>
    <p>Input:<br><textarea class="kindeditor" rows=13 name=input
                           cols=120><?php echo htmlentities($row->input, ENT_QUOTES, "UTF-8") ?></textarea></p>
    <p>Output:<br><textarea class="kindeditor" rows=13 name=output
                            cols=120><?php echo htmlentities($row->output, ENT_QUOTES, "UTF-8") ?></textarea></p>

    <p>Sample Input:<br><textarea rows=13 name=sample_input
                                  cols=120><?php echo htmlentities($row->sample_input, ENT_QUOTES, "UTF-8") ?></textarea>
    </p>
    <p>Sample Output:<br><textarea rows=13 name=sample_output
                                   cols=120><?php echo htmlentities($row->sample_output, ENT_QUOTES, "UTF-8") ?></textarea>
    </p>
    <p>Hint:<br>
        <textarea class="kindeditor" rows=13 name=hint
                  cols=120><?php echo htmlentities($row->hint, ENT_QUOTES, "UTF-8") ?></textarea></p>
    </p>
    <p>SpecialJudge:
    ...
    <p>Source:<br><textarea name=source rows=1
                            cols=70><?php echo htmlentities($row->source, ENT_QUOTES, "UTF-8") ?></textarea></p>
    <div align=center>
